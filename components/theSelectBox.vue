<template>
  <div
    ref="container_el"
    class="relative z-10 cursor-pointer rounded border border-solid border-c-line-gray py-1 pl-2 text-c-gray-200"
    @click="toggleList"
  >
    ...
    <ul v-if="isOpen" class="absolute top-full right-0 mt-1 w-[120px] rounded border border-c-line-gray bg-white py-1">
      <li
